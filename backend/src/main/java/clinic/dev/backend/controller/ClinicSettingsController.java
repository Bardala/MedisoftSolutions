...
// @PostMapping
// public ResponseEntity<ApiRes<ClinicSettings>> saveSettings(@RequestBody
// ClinicSettings settings) {
// return ResponseEntity.ok(new
// ApiRes<>(settingsService.saveSettings(settings)));
// }

// @PutMapping("/{id}")
// public ResponseEntity<ApiRes<ClinicSettings>>
// updateSettings(@PathVariable("id") Long id,
// @RequestBody ClinicSettings updatedSettings) {
// return ResponseEntity.ok(new ApiRes<>(settingsService.updateSettings(id,
// updatedSettings)));
// }
// }
