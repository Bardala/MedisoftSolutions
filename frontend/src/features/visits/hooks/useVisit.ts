...
import { useLogin, LOCALS } from "@/app";
import { VisitApi } from "@/core";
import { VisitResDTO, VisitReqDTO } from "@/dto";
import { useRecordPayment, useAddVisitPayment } from "@/features/billing";
import { useAddPatientToQueue } from "@/features/queue";
import {
  ApiError,
  Patient,
  Visit,
