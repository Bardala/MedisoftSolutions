...
import "@styles/prescriptionPrint3.css";
import { LoadingSpinner, Table, VisitMedicine } from "@/shared";
...
const PrescriptionPrint3: FC<PrescriptionPrintProps> = ({ visit, logo }) => {
...
export default PrescriptionPrint3;
